...
<head>
    ...
    <title>SIK ONLINE &copy SISTEM INFORMASI KELULUSAN & NILAI ONLINE</title>
                    ...
                    <div class="container" style="height: 100%; display: flex; justify-content: center; align-items: center;">
                        <div style="top: 50%; transform:translate(0, -50%); position: absolute;">
                            <div class="well">
                                ...
                                <h4 align="center" style="margin: 15px 0 -10px 0;"><b>SISTEM INFORMASI</br>STATUS KELULUSAN & NILAI SISWA</b></h4>
                                <hr>
                                <script>
                                    function cekNo() {
                                ...
                                <div id="xpengumuman">
                                    <div class="alert alert-dismissable alert-success">
                                        <h4 align=" center">
                                            <b>PENGUMUMAN STATUS KELULUSAN & NILAI</br>TAHUN <?= $tahun ?> DIBUKA
                                            </b>
                                        </h4>
                                    </div>
                                    <hr>
        ...
        $('#clock').countdown("<?= $tgl_pengumuman; ?>", {
            ...
            .on('update.countdown', function(event) {
                ...
                if (event.elapsed) {
                    ...
                    $this.html(event.strftime('<strong>WAKTU PENGUMUMAN KELULUSAN & NILAI </br>%H JAM %M MENIT %S DETIK</strong>'));
                    $("#xpengumuman").hide();
                }
            });
    </script>
