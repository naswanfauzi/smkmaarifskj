                ...
                <td style="padding: 10px;">
                    ...
                    while ($data = mysqli_fetch_array($q)) {
                        echo "<div class='well' style='margin-top: 15px;' >
                            ...
                            <h4 align='center' style='margin: 15px 0 -10px 0;'><b>SISTEM INFORMASI</br>STATUS KELULUSAN & NILAI SISWA</b></h4><hr>
                            <div align='center' class='alert alert-dismissable alert-success'><h4><b>SMK MAARIF SUKOHARJO</b></h4></div>";
